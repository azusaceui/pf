...
public partial class p1 : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        wenjuan += Label4.Text + "<br/>" + cb(CheckBoxList2) + "<br/><br/>";
        ...
        wenjuan += RadioButtonList8.Text + "<br/><br/>";
        wenjuan += Label9.Text + "<br/>" + tongji() + "<br/><br/>";
        wenjuan += Label10.Text + "<br/>" + RadioButtonList10.Text ;
    ...
    protected string tongji()
    {
        ...
        if (DropDownList5.Text != "0") tt += DropDownList5.Text + ",授課師資;";
